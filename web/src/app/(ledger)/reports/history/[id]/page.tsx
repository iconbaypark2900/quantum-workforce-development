...
import { getLabRun, downloadReportPdf } from "@/lib/api";
import {
  useNextPageProps,
    ...
    <div className="p-6 lg:p-10 max-w-4xl mx-auto space-y-8 print:p-8 print:max-w-none">
      ...
      <div className="flex flex-wrap gap-3 print:hidden">
        ...
        <button
          ...
          disabled={!id || pdfLoading}
          className="px-4 py-2 rounded-lg text-sm font-bold border border-ql-outline-variant text-ql-on-surface-variant hover:bg-ql-surface-container transition-colors disabled:opacity-40"
