...
from core.quantum_inspired.enhanced_graph_builder import EnhancedFinancialGraphBuilder
from core.quantum_inspired.enhanced_evolution_dynamics import EnhancedQuantumEvolution
from core.quantum_inspired.enhanced_stability_enhancer import EnhancedStabilityEnhancer
...
global_optimizer = EnhancedQuantumStochasticWalkOptimizer()
...
def optimize_portfolio():
    ...
    try:
        ...
        response = {
            ...
            'risk_metrics': {
                'var_95': float(result.riskMetrics['var95']),
                'cvar': float(result.riskMetrics['cvar'])
            },
